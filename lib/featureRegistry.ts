...
export const FEATURE_REGISTRY: FeatureEntry[] = [
  ...
  },
  {
    ...
    evidence: ["OFFER_LEVEL", "https://www.iqsight.com/en/products/video-analytics/iva-pro-visual-gun-detection/mvc-iva-vgd"],
    image: null,
  ...
  },
  {
    ...
    evidence: ["lib/feature-explorer.ts", "lib/feature-explorer.ts"],
  ...
  },
  {
    ...
    evidence: ["OFFER_LEVEL", "https://www.iqsight.com/en/products/video-analytics"],
    image: null,
