...
metaDescription: "An employee can refuse biometric attendance under the DPDP Act. What a lawful fallback looks like, and why forcing it is a bad fight."
readTime: 5
faqs:
  ...
  - q: "Can a company fire or discipline someone for refusing biometrics?"
    a: "Not for the refusal itself. Disciplinary action has to rest on actual absence or lateness recorded through the fallback method, not on declining to enrol. Treat the refusal as a process question, not a conduct issue."
  - q: "What is a lawful fallback for biometric attendance?"
    a: "A card, a PIN-based entry, or a manual register entry backed by a supervisor's sign-off — any method that records presence without capturing a fingerprint or face template. It should log the same fields (name, time, location) as the biometric system so reports stay consistent."
