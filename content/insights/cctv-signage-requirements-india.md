...
faqs:
  ...
  - q: "What should a CCTV notice say?"
    a: "State that the premises is under CCTV surveillance, the purpose (safety and security), the retention period, and a contact for queries — for example, 'This premises is under CCTV surveillance for the safety and security of staff and visitors. Footage is retained for [X days].' Keep it visible before someone enters the monitored area, not only inside it."
  - q: "Where should CCTV signs be placed?"
    a: "At every public entrance a camera actually covers, at separately monitored areas like parking or loading bays, and on a staff notice board with wording that covers employee monitoring. Never inside washrooms or changing rooms, which cameras must not cover at all."
  - q: "Does CCTV signage help or hurt security?"
    a: "It helps far more than it hurts. Most theft is opportunistic, and a visible notice removes the ambiguity a casual opportunist relies on. It doesn't expose your blind spots — a sign at a covered entrance says nothing about what is left uncovered elsewhere."
...
1. **Compliance gap.** A future data-protection complaint or inspection can point to the absence of a notice as evidence the basic disclosure standard wasn't met, even if the actual data handling was fine.
2. **A wasted deterrent.** You give up a free, passive layer of protection that costs nothing beyond printing a sign.
3. **Evidence disputes.** In disputes over a specific incident, whether notice existed sometimes becomes a talking point in questions about consent, particularly for footage used in HR matters.
